...
//------- Using UW Worldcat insteadof worldcat global ----------------------------------------
//------ var url = "http://www.worldcat.org/search?qt=worldcat_org_all&q=" 
//--------------------------------------------------------------------------------------------
...
function BibRecord2()  {	//----------- If we are in a bib.record details page -------------------------
	...
	//----------- for now we will just change their view so WC search works -------------------
...
//	sqf = sqf.replace("+", " ");
	...
	wcqindex="";  }
     ...
     if (/^[adtN]%3A/.test(sqf) || / [adtN]%3A/.test(sqf)) { //--- advanced keyword search limits selected ? ---
...
//========================== Find the form input fields if the form itself is not named ===========================
    ...
    if ((document.searchtool) || (fmxval) || (sfarg))
    {
     ...
     if (/^[adtN]:/.test(sfarg) || / [adtN]:/.test(sfarg)) { //--- advanced keyword search limits selected ? ---
...
//================================ In case we need to reference the string elswhere ===========================
    	//	            if (str.indexOf("&m=a") > -1 || (str.indexOf("?M=a") > -1)) {
        // 		    	wclimit="&fq=dt%3Abks+%3E"; }
 	//   		    else if (str.indexOf("&m=c") > -1 || (str.indexOf("?M=c") > -1)) {
        //  		    	wclimit="&fq=dt%3Asco+%3E"; }
 	//   		    else if (str.indexOf("&m=d") > -1 || (str.indexOf("?M=d") > -1)) {
        //   		    	wclimit="&fq=dt%3Arec+%3E"; }
	//   		    else if (str.indexOf("&m=e") > -1 || (str.indexOf("?M=e") > -1)) {
        //  		    	wclimit="&fq=dt%3Amap+%3E"; }
 	//   		    else if (str.indexOf("&m=f") > -1 || (str.indexOf("?M=f") > -1)) {
        //   		    	wclimit="&fq=dt%3Amap+%3E"; }
 	//   		    else if (str.indexOf("&m=g") > -1 || (str.indexOf("?M=g") > -1)) {
        //  		    	wclimit="&fq=dt%3Avis+%3E"; }
 	//   		    else if (str.indexOf("&m=i") > -1 || (str.indexOf("?M=i") > -1)) {
        //   		    	wclimit="&fq=fm%3Ansr+%3E"; }
 	//   		    else if (str.indexOf("&m=j") > -1 || (str.indexOf("?M=j") > -1)) {
        //   		    	wclimit="&fq=fm%3Amsr+%3E"; }
	//   		    else if (str.indexOf("&m=k") > -1 || (str.indexOf("?M=k") > -1)) {
        //   		    	wclimit="&fq=dt%3Avis+%3E"; }
 	//   		    else if (str.indexOf("&m=m") > -1 || (str.indexOf("?M=m") > -1)) {
        //   		    	wclimit="&fq=dt%3Acom+%3E"; }
 	//   		    else if (str.indexOf("&m=o") > -1 || (str.indexOf("?M=o") > -1)) {
        //   		    	wclimit="&fq=dt%3Avis+%3E"; }
	//   		    else if (str.indexOf("&m=p") > -1 || (str.indexOf("?M=p") > -1)) {
        //   		        wclimit=""; }  //-------------- NO CORRESPONDING WC CATEGORY ----------
 	//   		    else if (str.indexOf("&m=r") > -1 || (str.indexOf("?M=r") > -1)) {
        //   		    	wclimit="&fq=dt%3Avis+%3E"; }
 	//   		    else if (str.indexOf("&m=t") > -1 || (str.indexOf("?M=t") > -1)) {
        //		    	wclimit="&fq=dt%3Amix+%3E"; }
 	//  		    else  {
        //         	    	wclimit=wclimit;  }
...
//======================== If Multiple Limits ====================================
    		   ...
    		   if ( ((d1) || (d2) && (wclimit) && (wclang)) || ((wclimit) && (wclang)) || (((str.indexOf("&m=") > -1 || str.indexOf("?M=") > -1) && ((str.indexOf("&l=") > -1 || str.indexOf("?L=") > -1 || str.indexOf("&L=") > -1))) || ((str.indexOf("&l=") > -1 || str.indexOf("?L=") > -1) || str.indexOf("&L=") > -1 && ((str.indexOf("&Da=") > -1 || str.indexOf("&Db=") > -1 || str.indexOf("&Ya=") > -1 || str.indexOf("&Yb=") > -1)))))
                       {
...
//     		            if (str.indexOf("&l=ara") > -1 || (str.indexOf("?L=ara") > -1)) {
//           		    	wclang="&fq=ln%3Aara+%3E"; }
// 	   		    else if (str.indexOf("&l=chi") > -1 || (str.indexOf("?L=chi") > -1)) {
//           		    	wclang="&fq=ln%3Achi+%3E"; }
// 	   		    else if (str.indexOf("&l=cze") > -1 || (str.indexOf("?L=cze") > -1)) {
//           		    	wclang="&fq=dt%3Arec+%3E"; }
// 	   		    else if (str.indexOf("&l=eng") > -1 || (str.indexOf("?L=eng") > -1)) {
//           		    	wclang="&fq=ln%3Aeng+%3E"; }
// 	   		    else if (str.indexOf("&l=fre") > -1 || (str.indexOf("?L=fre") > -1)) {
//          		    	wclang="&fq=ln%3Afre+%3E"; }
// 	   		    else if (str.indexOf("&l=ger") > -1 || (str.indexOf("?L=ger") > -1)) {
//           		    	wclang="&fq=ln%3Ager+%3E"; }
// 	   		    else if (str.indexOf("&l=ita") > -1 || (str.indexOf("?L=ita") > -1)) {
//           		    	wclang="&fq=ln%3Ait+%3E"; }
// 	   		    else if (str.indexOf("&l=lat") > -1 || (str.indexOf("?L=lat") > -1)) {
//           		    	wclang="&fq=ln%3Alat+%3E"; }
// 	   		    else if (str.indexOf("&l=jpn") > -1 || (str.indexOf("?L=jpn") > -1)) {
//           		    	wclang="&fq=ln%3Ajpn+%3E"; }
// 	   		    else if (str.indexOf("&l=por") > -1 || (str.indexOf("?L=por") > -1)) {
//           		    	wclang="&fq=ln%3Apor+%3E"; }
// 	   		    else if (str.indexOf("&l=rus") > -1 || (str.indexOf("?L=rus") > -1)) {
//          		    	wclang="&fq=ln%3Arus+%3E"; }
// 	   		    else if (str.indexOf("&l=spa") > -1 || (str.indexOf("?L=spa") > -1)) {
//          		        wclang="&fq=ln%3Aspa+%3E"; } 
// 	   		    else if (str.indexOf("&l=fin") > -1 || (str.indexOf("?L=fin") > -1)) {
//           		    	wclang="&fq=ln%3Afin+%3E"; }
// 	   		    else if (str.indexOf("&l=heb") > -1 || (str.indexOf("?L=heb") > -1)) {
//           		    	wclang="&fq=ln%3Aheb+%3E"; }
// 	   		    else  {
//                 	    	wclang=wclang;  }
